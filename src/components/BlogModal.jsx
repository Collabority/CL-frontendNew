  ...
  return (
    ...
    >
      <div className="bg-white max-w-2xl w-full rounded-lg shadow-lg overflow-y-auto max-h-[90vh] relative">
        ...
        <button
          className="absolute top-4 right-4 text-gray-500 hover:text-[#008080] text-2xl font-bold z-10 p-2 focus:outline-none"
          onClick={onClose}
        ...
        <div className="p-6">
          ...
          <img 
            src={blog.image} 
            alt={blog.title} 
            loading="eager" /** PRIORITY: Main modal image */
          ...
          <div className="mt-8 border-t border-gray-200 pt-6">
                    ...
                    <div className="flex justify-between w-full">
                      <div>
                        ...
                        <p className="text-gray-500 text-xs flex items-center">
                          <FaCalendarAlt aria-hidden="true" className="h-3 w-3 mr-1 text-[#008080]" /> 
                          {comment.date}
                        </p>
                      </div>
            ...
            <form className="space-y-3 p-4 bg-[#F8F6F3] rounded-lg border-2 border-gray-200">
              <div className="relative">
                <textarea 
                  className="w-full p-3 border border-gray-100 bg-white focus:outline-none focus:ring-2 focus:ring-[#008080] pr-10 text-xs rounded" 
                  rows="3" 
                  placeholder="Type your comments...."
                  aria-label="Comment text"
                ></textarea>
                <FaRegEdit aria-hidden="true" className="absolute right-3 top-3 text-gray-900" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="relative">
                  <input type="text" className="w-full p-3 border border-gray-100 bg-white focus:outline-none focus:ring-2 focus:ring-[#008080] pr-10 text-xs rounded" placeholder="Name" />
                  <FaRegUser aria-hidden="true" className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-900" />
                </div>
                <div className="relative">
                  <input type="email" className="w-full p-3 border border-gray-100 bg-white focus:outline-none focus:ring-2 focus:ring-[#008080] pr-10 text-xs rounded" placeholder="Email" />
                  <FaRegEnvelope aria-hidden="true" className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-900" />
                </div>
              </div>
              <button type="submit" className="bg-[#008080] text-white font-bold py-2 px-4 hover:bg-[#006666] transition duration-300 flex items-center rounded text-xs">
                <FaCommentAlt aria-hidden="true" className="h-4 w-4 mr-2" /> Post Comment
              </button>
            </form>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-300 mt-8 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-900 text-xs mb-1 font-medium">{author.title}</p>
                <p className="text-gray-900 text-xs leading-relaxed">{author.bio}</p>
              </div>
            </div>
          </div>
        </div>
...
/** @MEMOIZED */
export default React.memo(BlogModal);