...
const StatsCard = ({ icon, number, label }) => {
  return (
    <div className="bg-beige rounded-lg shadow-lg p-8 flex flex-col items-center text-center transition-transform duration-300 hover:scale-105">
      <div 
        aria-hidden="true"
        className="w-16 h-16 flex items-center justify-center rounded-full bg-teal text-white text-2xl mb-4"
      >
        <FontAwesomeIcon
          icon={icon}
      ...
      <p className="text-4xl font-bold text-gray-900 mb-2">{number}</p>
