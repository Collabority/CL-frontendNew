...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-poppins">
      ...
      <section className="relative w-full bg-gradient-to-b from-[#eaf1fb] to-white pt-16 pb-20 flex flex-col items-center justify-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 justify-items-center">
          {serviceCards.map((card, idx) => (
            <div
              ...
              className={`relative overflow-hidden group shadow-lg w-full max-w-sm h-96 rounded-none bg-white flex flex-col justify-end transition-all duration-700 ease-in-out
      ...
      {/* Intro Video Section */}
      <section className="w-full bg-[#F5FAFE] py-20 mb-20">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 px-4">
          ...
          <div className="relative w-full md:w-1/2 flex justify-center items-center">
            <div className="relative">
              <img
                ...
                alt="Intro Video"
                className="w-[480px] h-[540px] object-cover border-b-[12px] border-l-[12px] border-[#2563eb] shadow-lg"
              />
              ...
              >
                <motion.span
                  className="relative z-10 flex items-center justify-center w-24 h-24 rounded-full bg-[#0D59DB] text-white text-4xl shadow-lg"
                  animate={{
                    boxShadow: [
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-start">
            ...
            <button className="bg-[#2563eb] text-white text-lg font-semibold px-8 py-4 rounded-none shadow hover:bg-[#1746a2] transition-colors">Learn More</button>
          </div>
        </div>
      </section>
      <HistoryTimeline />
      ...
      <footer className="relative bg-[#0a2256] text-white py-16 overflow-hidden">
