      ...
      <section className="py-12 sm:py-20 px-4 sm:px-8 lg:px-20 flex flex-col lg:flex-row gap-5 lg:gap-5">
        ...
        <div className="mt-10 lg:mt-40 flex flex-col lg:text-left lg:w-1/2">
          ...
          <h2 className="text-gray-900 text-6xl font-bold mt-4 leading-18">
            Fueling Visibility, <br /> Driving Results
          </h2>
          <p className="mt-10 text-xs opacity-[50%] leading-5">
            At Collabority, we go beyond traditional marketing to deliver
            integrated strategies that drive real <br /> business growth. From
            performance marketing and content planning to audience targeting and{" "}
            <br /> brand positioning — every move is data-backed and
            result-oriented. Our focus is on helping your <br /> brand scale
            faster, smarter, and stronger in the digital era.
          </p>
      ...
      <section className="bg-gray-900 h-screen py-12 sm:py-20 px-4 sm:px-8 lg:px-20 flex flex-col lg:flex-row gap-5 lg:gap-5">
        <div className="flex flex-col ml-32">
          ...
          <h5 className="text-gray-500 text-lg font-base leading-7 mt-6">
            Delivering integrated IT, marketing, and design <br /> solutions for
          ...
          <p className="text-gray-300 text-xs font-base leading-7 mt-6">
            ...
            impactful <br /> marketing strategies, creative design, and
            professional video production. Our <br /> approach is rooted in
            understanding your business goals and crafting digital <br />{" "}
            experiences that deliver real value. Whether it's transforming
            operations through <br /> technology or enhancing brand presence
            with compelling media, we provide <br /> end-to-end solutions for
