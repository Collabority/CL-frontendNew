...
const Career = () => {
  ...
  return (
    <main className="min-h-screen bg-white font-poppins">
      ...
      {/* Hero Section */}
      <section
        className={`flex flex-col items-center justify-center py-10 px-5 bg-white text-center`}
      >
        <div className={`mb-1 max-w-[800px]`}>
          <h1 className="text-[3.5em] font-bold text-[#24221E] mb-[30px] leading-[1.2]">
            Breaking the status
            <br />
            quo to make an
            <br />
        ...
        >
          {awards.map((award, index) => (
            <div key={index} className={`flex items-center gap-1`}>
              ...
              />
              <div
                className={`flex-none bg-transparent p-0 rounded-none shadow-none flex flex-col items-center text-center`}
              >
                <p className={`text-[0.8em] text-[#6F6D6B]`}>{award.title}</p>
                <p className={`text-[1.1em] font-bold text-[#24221E]`}>
                  {award.awardName}
                </p>
                <p className={`text-[0.8em] text-[#6F6D6B]`}>By {award.by}</p>
              </div>
              <img
                src={RightLaurelPng}
                alt="Right Laurel"
      ...
      {/* Application Process */}
      <section className="w-full min-h-screen bg-[url('/src/assets/image3.avif')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-4">
        {/* Heading */}
        ...
        {/* Paragraph */}
        <div className="max-w-xl text-left mt-4 flex flex-col gap-6">
